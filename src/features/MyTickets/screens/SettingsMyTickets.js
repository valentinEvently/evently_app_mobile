...
const SettingsMyTickets = () => {
  ...
  return (
    <View className="bg-secondary flex-1">
      ...
      <TouchableOpacity className="p-4 m-4 bg-inputPrimary rounded-md" onPress={() => navigation.navigate('ProfileMyTickets')}>
...
export default SettingsMyTickets
