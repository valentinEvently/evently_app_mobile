...
const filterMarketplaceSlice = createSlice({
...
export const { clear, addMonth, addYear, addMinPrice, addMaxPrice } = filterMarketplaceSlice.actions

export default filterMarketplaceSlice.reducer
